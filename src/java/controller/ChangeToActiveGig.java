 ...
 * @author User
 */
@WebServlet(name = "ChangeToActiveGig", urlPatterns = {"/ChangeToActiveGig"})
public class ChangeToActiveGig extends HttpServlet {
            ...
            if (user.getUser_Status().getValue().equals("Active") && user.getVerification().equals("VERIFIED!") && user.getUser_Type().getValue().equals("Seller") && user.getDob() != null && user.getUser_Has_Address() != null && user.getLocale() != null) {
                ...
                if (!criteria.list().isEmpty()) {
                    ...
                    if (!criteria1.list().isEmpty()) {
                        ...
                        responseObject.addProperty("message", gig.getTitle() + " set as a Active Gig.");
                    }
                }
