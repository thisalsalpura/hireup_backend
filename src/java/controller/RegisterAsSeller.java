            ...
            if (email.equals(user.getEmail())) {
                ...
                if (criteria.list().isEmpty()) {
                    ...
                    if (BCrypt.checkpw(password, u.getPassword())) {
                        if (u.getDob() == null || u.getUser_Has_Address() == null || u.getLocale() == null) {
                            responseObject.addProperty("user", "NOTUPDATED");
                            responseObject.addProperty("message", "Please update your User Profile!");
                        } else {
