                ...
                if (user.getUser_Status().getValue().equals("Active") && user.getVerification().equals("VERIFIED!")) {
                    ...
                    if (user.getDob() != null && user.getUser_Has_Address() != null && user.getLocale() != null) {
                        ...
                        if (!criteria.list().isEmpty()) {
                            ...
                            payHereJson.addProperty("return_url", "https://b368bf8902a8.ngrok-free.app/returnPayment?orderId=" + orderId);
                            payHereJson.addProperty("cancel_url", "https://b368bf8902a8.ngrok-free.app/cancelPayment");
                            payHereJson.addProperty("notify_url", "https://da10311ecb8f.ngrok-free.app/hireup_backend/NotifyPayment");
