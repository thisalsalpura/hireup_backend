                ...
                if (user.getUser_Status().getValue().equals("Active") && user.getVerification().equals("VERIFIED!")) {
                    ...
                    if (user.getDob() != null && user.getUser_Has_Address() != null && user.getLocale() != null) {
                        ...
                        if (!criteria.list().isEmpty()) {
                            ...
                            payHereJson.addProperty("return_url", "https://cd4c1448abcf.ngrok-free.app/returnPayment?orderId=" + orderId);
                            payHereJson.addProperty("cancel_url", "https://cd4c1448abcf.ngrok-free.app/cancelPayment");
                            payHereJson.addProperty("notify_url", "https://8fc46095876e.ngrok-free.app/hireup_backend/NotifyPayment");
